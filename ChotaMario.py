...
class player(object):
    ...
    def draw(self,win):
        ...
        """ this draw rectangle around player """
        #pygame.draw.rect(win,(255,0,0),(self.x,self.y,self.width,self.height),2)


#making the projectile motion class
...
class enemy(object):
    ...
    def move(self):
        """only for x coordinate for y just change y in code"""
...
""" To do colosion in pygame we use the rectangle of png"""
    
#draw image function

def redraw():
    
    win.blit(bg,(0,0))# to write an image in background
...
while run:
    clock.tick(27)# how much frame we see per second
